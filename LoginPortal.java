...
public class LoginPortal extends javax.swing.JFrame {
    ...
    public LoginPortal() {
        initComponents();
        this.setBounds(300,100,950,550);
    }
    ...
    private void initComponents() {
        ...
        email.setText("  Email");
        email.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102), 2));
        ...
        username.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102), 2));

        jLabel2.setBackground(new java.awt.Color(102, 153, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 36)); // NOI18N
        jLabel2.setText("Point of");
        ...
        password.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102), 2));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JPanal/icon/staff.png"))); // NOI18N
...
if (!enteredUsername.isEmpty() && !enteredPassword.isEmpty() && !enteredEmail.isEmpty()) {
    if (enteredUsername.equalsIgnoreCase("Admin") && enteredPassword.equals("2222") && enteredEmail.equalsIgnoreCase("admin@gmail.com")) {
    ...
    else if (enteredUsername.equalsIgnoreCase("Employee") && enteredPassword.equals("1234") && enteredEmail.equalsIgnoreCase("employee@gmail.com")) {
        this.setVisible(false); 
        this.dispose();         
    ...
    JOptionPane.showMessageDialog(this, "Fields are empty! Please fill in all the required fields.", "Input Error", JOptionPane.WARNING_MESSAGE);
}
